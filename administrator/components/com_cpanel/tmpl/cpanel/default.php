...
Text::script('COM_CPANEL_MSG_MODULE_ADDED');
Text::script('COM_CPANEL_UNPUBLISH_MODULE_SUCCESS');
Text::script('COM_CPANEL_UNPUBLISH_MODULE_ERROR');

HTMLHelper::_('script', 'com_cpanel/admin-cpanel-default.js', ['version' => 'auto', 'relative' => true]);
...
<?php if (Factory::getApplication()->getIdentity()->authorise('core.manage', 'com_modules')) : ?>
<div class="row">
	<div class="col-md-6">
		<a href="#moduleEditModal" data-toggle="modal" data-target="#moduleDashboardAddModal"
           role="button" class="cpanel-add-module text-center py-5 w-100 d-block">
